"""
FCS Real-time Cryptocurrency Example with Flask

Real-time Crypto price streaming using WebSocket
Demo API Key: fcs_socket_demo

Install: pip install flask
Run: python flask_crypto_example.py
...
<head>
    ...
    <title>FCS Real-time Crypto - Flask Example</title>
...
<body>
    <div class="container">
        ...
        <div class="api-hint">
            Demo API Key: <code>fcs_socket_demo</code> - Get your free API key at <a href="https://fcsapi.com" style="color: #f7931a;">fcsapi.com</a>
        </div>
    </div>
...
if __name__ == '__main__':
    print("Starting FCS Real-time Crypto Example (Flask)...")
