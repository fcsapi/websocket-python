"""
FCS Real-time Cryptocurrency Example

Real-time Crypto price streaming using WebSocket
...
<head>
    ...
    <title>FCS Real-time Crypto - Python Example</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card:hover {
            ...
            box-shadow: 0 15px 50px rgba(247, 147, 26, 0.1);
        }
        .card-header {
            display: flex;
        ...
        .spread-label { font-size: 0.75rem; color: #555; }
        .spread-value { font-size: 1.1rem; font-family: 'Monaco', monospace; }
        .ask { color: #00ff88; }
        .bid { color: #ff4757; }
        .api-hint {
            text-align: center;
...
<body>
    <div class="container">
        ...
        <div class="api-hint">
            Demo API Key: <code>fcs_socket_demo</code> - Get your free API key at <a href="https://fcsapi.com" target="_blank" style="color: #f7931a;">fcsapi.com</a>
        </div>
    </div>
...
if __name__ == '__main__':
    ...
    print(f"Starting FCS Real-time Crypto Example...")
